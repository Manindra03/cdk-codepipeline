...
class CdkCodepipelineStack(Stack):
    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        git_input = pipelines.CodePipelineSource.connection(
            repo_string="manindra03/cdk-codepipeline",
            branch="main",
            connection_arn="arn:aws:codestar-connections:eu-central-1:178375044839:connection/5ba58d40-4796-443d-bd86-37c610f0e665"
        )
        ...
        deployment_wave.add_stage(DeployStage(
            self, 'DeployStage',
            env=(Environment(account='178375044839', region='eu-central-1'))
        ))
